...
export default function PatientPrescriptionsPage() {
  ...
  useEffect(() => {
    ...
    setPrescriptions(getPrescriptions("PAT-001"));
    setLoading(false);
  }, [session, router]);
  ...
  return (
    <RoleShell role="PATIENT">
      <div className="mb-8">
        ...
        <h1 className="font-display mt-2 text-3xl font-semibold text-slate-950 sm:text-4xl">My Prescriptions</h1>
        <p className="mt-2 text-sm text-slate-500">View your prescriptions and medication history.</p>
      </div>
      ...
      <div className="space-y-4">
        {prescriptions.length === 0 ? (
          <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">You don&apos;t have any prescriptions yet.</p>
          </div>
        ) : (
