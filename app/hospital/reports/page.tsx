  ...
  return (
    <RoleShell role="HOSPITAL">
      <div className="mb-8">
        ...
        <h1 className="font-display mt-2 text-3xl font-semibold text-slate-950 sm:text-4xl">Reports</h1>
        <p className="mt-2 text-sm text-slate-500">View lab and medical reports.</p>
      </div>
      ...
      <div className="space-y-4">
        {reports.length === 0 ? (
          <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">No reports available.</p>
          </div>
        ) : (
          reports.map((report) => (
